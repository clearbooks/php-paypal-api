...
class BMCreateButtonRequestType extends AbstractRequestType
{
     ...
     * @access public
     */
    public function __construct($DetailLevel, $ErrorLanguage, $Version, $any, $ButtonType, $ButtonCode, $ButtonSubType, $ButtonVar, $OptionDetails, $TextBox, $ButtonImage, $ButtonImageURL, $BuyNowText, $SubscribeText, $ButtonCountry, $ButtonLanguage)
    {
